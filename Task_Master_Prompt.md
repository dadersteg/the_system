...
- **PMT vs. General Work:** Do NOT assign a task the Playmetech category path simply because it is work-related. For general career development, networking, or matters relating to other companies, you MUST use the Career Management category (e.g., `02 02 00 Career Management`). Playmetech is strictly reserved for active employment at Playmetech.
- **Manual Overrides:** If the task description or title contains explicit instructions from the user like "DA: THIS IS NOT A PMT TASK" or "DA: PERSONAL", you MUST explicitly obey this and select a NON-Playmetech category path. Never ignore user instructions.
