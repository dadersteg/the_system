...
const IS_CE_ENV = ENABLE_CE_FEATURES && (getEnvProp("ENV") === "WORK");

const SYSTEM_CONFIG = {
  SECRETS: {
    GEMINI_API_KEY: getEnvProp("GEMINI_API_KEY"),
    GEMINI_PRIMARY_MODEL: "gemini-3.7-flash",            // Primary Engine Across EVERYTHING
    GEMINI_MODEL_PRO: "gemini-3.7-flash",                // Reasoning Primary
    GEMINI_MODEL_FLASH: "gemini-3.7-flash",              // Flash Primary
    GEMINI_MODEL_FLASH_LITE: "gemini-3.7-flash",         // Ingestion Primary (Defaults to 3.7 Flash)
    GEMINI_FALLBACK_PRO: "gemini-pro-latest",            // Heavy Reasoning Fallback (3.1 Pro)
    GEMINI_FALLBACK_LITE: "gemini-flash-lite-latest",    // High-throughput Ingestion Fallback (3.5 Flash Lite)
    GEMINI_RETRO_MODEL: "gemini-3.7-flash",
    GEMINI_MODEL_2M_RETRO: "gemini-1.5-pro-latest",      // 2M Large-Context Fallback
  },
