...
function askGeminiNotes(mode, text, systemPrompt, taxonomyJson, recentContext = "") {
    ...
    let result = callGemini(parts, primaryModel, "You are an assistant.", null, false);
    ...
    if (!result || result.error) {
        ...
        if (primaryModel !== liteFallback) {
            ...
            result = callGemini(parts, liteFallback, "You are an assistant.", null, false);
        }
    }
    if (!result || result.error) {
        ...
        if (primaryModel !== proFallback) {
            ...
            result = callGemini(parts, proFallback, "You are an assistant.", null, false);
        }
    }
    if (result && !result.error) {
