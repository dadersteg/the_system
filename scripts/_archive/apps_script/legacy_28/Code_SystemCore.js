...
function setupSystemTriggers() {
  try {
    ...
    ScriptApp.newTrigger("runTheClerkDriveOngoing").timeBased().everyMinutes(15).create();
 ...
 */
function callGemini(promptText, modelName, systemInstruction, schema, isText = false) {
