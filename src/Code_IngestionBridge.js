 ...
 *
 * @changelog
 * - 1.0.1: Added JSDoc docstrings, standardized variables to let/const, and removed legacy commented code.
 ...
 * Parses the payload from JSON or fallback mechanisms and routes it to `processWebhook`.
 *
 * @param {GoogleAppsScript.Events.DoPost} e The POST request event object containing `postData` and/or `parameter`.
 ...
 *
 * @param {GoogleAppsScript.Events.DoPost} e The request event object containing the payload.
 * @returns {GoogleAppsScript.Content.TextOutput} A JSON response indicating success or error.
 */
